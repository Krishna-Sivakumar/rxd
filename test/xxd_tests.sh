...
# ./xxd_tests.sh
#
# This is a test suite adapted from https://github.com/ckormanyos/xxd.
#
...
$XXD -s +54 -len 13 -c 13 ../../doc/xxd.1 | grep '21st May 1996'
res_36=$?
echo
...
echo -n 'abc' | $XXD -cols 1 -e | grep '00000002: 63  c'
res_42=$?
echo
